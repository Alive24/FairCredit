...
export const REMOVE_COURSE_MODULE_DISCRIMINATOR = new Uint8Array([
  169, 162, 115, 53, 77, 226, 82, 131,
]);

export function getRemoveCourseModuleDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REMOVE_COURSE_MODULE_DISCRIMINATOR,
  );
}

export type RemoveCourseModuleInstruction<
...
export type RemoveCourseModuleInstructionData = {
  discriminator: ReadonlyUint8Array;
  resource: Address;
};

export type RemoveCourseModuleInstructionDataArgs = { resource: Address };

export function getRemoveCourseModuleInstructionDataEncoder(): FixedSizeEncoder<RemoveCourseModuleInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: REMOVE_COURSE_MODULE_DISCRIMINATOR,
    }),
  );
}

export function getRemoveCourseModuleInstructionDataDecoder(): FixedSizeDecoder<RemoveCourseModuleInstructionData> {
...
export function getRemoveCourseModuleInstructionDataCodec(): FixedSizeCodec<
  RemoveCourseModuleInstructionDataArgs,
  RemoveCourseModuleInstructionData
> {
  return combineCodec(
    getRemoveCourseModuleInstructionDataEncoder(),
    getRemoveCourseModuleInstructionDataDecoder(),
  );
}

export type RemoveCourseModuleAsyncInput<
...
> = {
  ...
  resource: RemoveCourseModuleInstructionDataArgs["resource"];
};

export async function getRemoveCourseModuleInstructionAsync<
  TAccountCourse extends string,
  TAccountProvider extends string,
...
>(
  input: RemoveCourseModuleAsyncInput<
    TAccountCourse,
    TAccountProvider,
    TAccountHub,
    TAccountProviderAuthority
...
> {
  ...
  return Object.freeze({
    ...
    data: getRemoveCourseModuleInstructionDataEncoder().encode(
      args as RemoveCourseModuleInstructionDataArgs,
    ),
    programAddress,
  } as RemoveCourseModuleInstruction<
    TProgramAddress,
    TAccountCourse,
    TAccountProvider,
    TAccountHub,
...
export type RemoveCourseModuleInput<
  TAccountCourse extends string = string,
  TAccountProvider extends string = string,
  TAccountHub extends string = string,
  TAccountProviderAuthority extends string = string,
...
export function getRemoveCourseModuleInstruction<
  TAccountCourse extends string,
  TAccountProvider extends string,
  TAccountHub extends string,
  TAccountProviderAuthority extends string,
...
export type ParsedRemoveCourseModuleInstruction<
  TProgram extends string = typeof FAIR_CREDIT_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RemoveCourseModuleInstructionData;
};

export function parseRemoveCourseModuleInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedRemoveCourseModuleInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRemoveCourseModuleInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
